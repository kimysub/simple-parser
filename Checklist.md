...
| Phase 12 | Table detection & PDF/PPTX quality (bordered/borderless tables, smart body size, heading length filters, ligature normalization, whitespace collapse, DrawingML tables, benchmark 100/100) | 3 `test_pdf` table + 3 `test_pptx` table + `benchmark.py` | PASS |
